  ...
  <div>
    <div class="zhiBuTuanYuan">
      <el-table :data="tableData">
        ...
        <el-table-column prop="title" align="center" label="会议类型"/>
        <el-table-column prop="theme" align="center" label="会议主题"/>
        <el-table-column prop="meetDate" align="center" label="会议时间"/>
        <el-table-column prop="place" align="center" label="会议地点"/>
        <el-table-column prop="content" align="center" label="会议内容"/>
      </el-table>
