    ...
    <div class="tuanke">
      <el-table :data="tableData">
        ...
        <el-table-column
          ...
          width="160"
        />
        <el-table-column prop="classHour" align="center" label="团课学时"/>
        <el-table-column prop="place" align="center" label="团课地点"/>
        <el-table-column prop="theme" align="center" label="团课主题"/>
        <el-table-column prop="content" align="center" label="团课内容"/>
      </el-table>
