<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="tuanKeDate" align="center" value-format="yyyy-MM-dd HH:mm:ss" label="团课时间" width="160"/>
      <el-table-column prop="classHour" align="center" label="团课学时" width="160"/>
      <el-table-column prop="place" align="center" label="团课地点" width="160"/>
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button type="danger" size="small" icon="el-icon-delete" plain @click="deleteTeamclass(scope.$index)"/>
        </template>
      </el-table-column>
    </el-table>
...
import {
  pageWithTeamclass, deleteTeamclass } from '@/api/teamclass'
export default {
  components: {
    page
  },
